...
#ifdef CUDA
  else if (!strcmp(knnClassifier->runType, "cuda1"))       cudaKnn1      (knnDataset, knnClassifier);
  else if (!strcmp(knnClassifier->runType, "cuda2"))       cudaKnn2      (knnDataset, knnClassifier);
#endif
  else {
